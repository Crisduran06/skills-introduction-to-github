...
SOURCE_SEED_DATA = [
    dict(name="Mountain View Official Bids", key="mountain_view", base_url="https://vendors.planetbids.com/portal/47527/bo/bo-search", platform_type="planetbids", status="live", scrape_allowed=True, auth_required=False, supports_current_bids=True, supports_bid_results=True, supports_awards=True, supports_archives=False, notes="PlanetBids REST API — open bids public, historical requires auth."),
    ...
    dict(name="EBMUD Construction Bids", key="ebmud", base_url="https://construction-bids.ebmud.com/CurrentorFutureBid.aspx?BidMode=Current", platform_type="public_page", status="live", scrape_allowed=True, auth_required=False, supports_current_bids=True, supports_archives=True, notes="ASP.NET WebForms — static HTML table, no login required."),
    ...
    dict(name="SFPUC / SF Bids", key="sfpuc", base_url="https://webapps.sfpuc.org/bids/bidlist.aspx?bidtype=5", platform_type="public_page", status="live", scrape_allowed=True, auth_required=False, supports_current_bids=True, supports_archives=True, notes="ASP.NET WebForms — shows contract numbers and dollar estimates publicly."),
    dict(name="SF Public Works", key="sf_public_works", base_url="https://bidopportunities.apps.sfdpw.org/", platform_type="public_page", status="live", scrape_allowed=True, auth_required=False, supports_current_bids=True, supports_archives=True, notes="ASP.NET MVC — shows estimates. Document download requires BSM login."),
    ...
    dict(name="VTA Procurement", key="vta", base_url="https://procurement.opengov.com/portal/vta", platform_type="opengov", status="live", scrape_allowed=True, auth_required=False, supports_current_bids=True, supports_archives=False, notes="OpenGov REST API — open bids public, historical requires auth."),
