...
SOURCE_SEED_DATA = [
    ...
    dict(name="VTA Procurement", key="vta", base_url="https://procurement.opengov.com/portal/vta", platform_type="opengov", status="live", scrape_allowed=True, auth_required=False, supports_current_bids=True, supports_archives=True, notes="OpenGov REST API — JSON, no auth required."),
